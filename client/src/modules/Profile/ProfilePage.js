...
export default class Profile extends React.PureComponent{
	...
	render(){
		return <div className="ms-Grid" style={{ marginTop: 10}}>
			<div className="ms-Row" style={centerContent}>
	            <Card bordered={false} style={{ width: '90%' }}>
	              ...
	              <div className="ms-Grid-row">
	              	...
	              	<div className="ms-Grid-col ms-lg3 ms-md2 ms-sm2">
	              	<Icon type="setting" style={{float: "right", marginTop: "5%", fontSize: 24}}/>
	              	</div>
	              </div>
	            </Card>
	          </div>
	          ...
	          <div className="ms-Grid-col ms-lg5 ms-md2 ms-sm2">
	          	<Card title="Eduardo Sanchez Bautista" bordered={false} style={{ marginTop: 10, marginBottom: 20, marginLeft: "10%"}}>
	          		<div className="ms-Grid-row">
	          				<Label><i className="ms-Icon ms-Icon--Suitcase" style={{ fontSize: 16, marginRight: 8, fontWeight: "bold"}} aria-hidden="true"/> Optilyz</Label>
	          		</div>
	          		<div className="ms-Grid-row">
	          				<Label><i className="ms-Icon ms-Icon--ReadingMode" style={{ fontSize: 16, marginRight: 8, fontWeight: "bold"}} aria-hidden="true"/> UPAEP</Label>
	          		</div>
	          		<div className="ms-Grid-row">
	          				<Label><i className="ms-Icon ms-Icon--Mail" style={{ fontSize: 16, marginRight: 8, fontWeight: "bold"}} aria-hidden="true"/> eduardo@gmail.com</Label>
	          		</div>
	          		<div className="ms-Grid-row">
	          				<Label><i className="ms-Icon ms-Icon--Mail" style={{ fontSize: 16, marginRight: 8, fontWeight: "bold"}} aria-hidden="true"/> eduardo@gmail.com</Label>
	          		</div>
